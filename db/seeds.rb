...
@generalA = Affirmation.create(affirmation:"ga", user_id:@user)
@loveA = Affirmation.create(affirmation: "love a")
@believeA = Affirmation.create(affirmation: "sunshine")
@careerA = Affirmation.create(affirmation: "stars")
@healthA = Affirmation.create(affirmation: "flowers")
